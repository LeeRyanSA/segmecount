...
//V8: Change of lower_Size and upper_Size to 0.025 and 50 (Reverted V7) (as shown, no change in comparison with V6)
//V9: Rolling background subtract from 10 to 15 pixels 

//Rolled Back to V5, applied V8 changes to lower broad range. 
